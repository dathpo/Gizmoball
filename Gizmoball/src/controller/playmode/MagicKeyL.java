 ...
 * one of them.
 */
public class MagicKeyL implements KeyListener {
     ...
     */
    public MagicKeyL(KeyListener adaptee) {
        this(adaptee, false);
    }

    /**
     * @param assumeAllReleased enables the third option listed in the class overview, namely
     *                          that any key release event implies that all keys have been
     *                          released.
     * @requires adaptee != null
     * @effects creates a new MagicKeyListener.
     */
    public MagicKeyL(KeyListener adaptee, boolean assumeAllReleased) {
        if (adaptee == null)
